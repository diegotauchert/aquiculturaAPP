...
class AgendaAnexoController extends Controller
{
     ...
     */
    public function delete(Request $request, \App\Models\AgendaAnexo $anexo)
    {
    ...
    {
        $anexo = new \App\Models\AgendaAnexo([
            'tipo' => $tipo,
            'post_id' => $post,
        ]);
        $anexo->save();
        ...
        if (!$upload) {
            ...
            $html = view('gestor.agendas.foto', compact('anexo'))->render();
    ...
    public function uploadArquivo($request, $post, $tipo)
    {
        ...
        if (!$upload) {
            ...
            $html = view('gestor.agendas.arquivo', compact('anexo'))->render();
            return response()->json(['html' => $html]);
        }
