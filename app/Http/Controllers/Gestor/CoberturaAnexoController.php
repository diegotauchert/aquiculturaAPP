...
class CoberturaAnexoController extends Controller
{
     ...
     */
    public function delete(Request $request, \App\Models\CoberturaAnexo $anexo)
    {
    ...
    {
        $anexo = new \App\Models\CoberturaAnexo([
            'tipo' => $tipo,
            'post_id' => $post,
        ]);
        $anexo->save();
        ...
        if (!$upload) {
            ...
            $html = view('gestor.coberturas.foto', compact('anexo'))->render();
    ...
    public function uploadArquivo($request, $post, $tipo)
    {
        ...
        if (!$upload) {
            ...
            $html = view('gestor.coberturas.arquivo', compact('anexo'))->render();
            return response()->json(['html' => $html]);
        }
