...
class EnsaioAnexoController extends Controller
{
     ...
     */
    public function delete(Request $request, \App\Models\EnsaioAnexo $anexo)
    {
    ...
    {
        $anexo = new \App\Models\EnsaioAnexo([
            'tipo' => $tipo,
            'post_id' => $post,
        ]);
        $anexo->save();
        ...
        if (!$upload) {
            ...
            $html = view('gestor.ensaios.foto', compact('anexo'))->render();
    ...
    public function uploadArquivo($request, $post, $tipo)
    {
        ...
        if (!$upload) {
            ...
            $html = view('gestor.ensaios.arquivo', compact('anexo'))->render();
            return response()->json(['html' => $html]);
        }
