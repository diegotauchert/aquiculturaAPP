...
class VaiPraOndeAnexoController extends Controller
{
     ...
     */
    public function delete(Request $request, \App\Models\VaiPraOndeAnexo $anexo)
    {
    ...
    {
        $anexo = new \App\Models\VaiPraOndeAnexo([
            'tipo' => $tipo,
            'post_id' => $post,
        ]);
        $anexo->save();
        ...
        if (!$upload) {
            ...
            $html = view('gestor.vaipraonde.foto', compact('anexo'))->render();
    ...
    public function uploadArquivo($request, $post, $tipo)
    {
        ...
        if (!$upload) {
            ...
            $html = view('gestor.vaipraonde.arquivo', compact('anexo'))->render();
            return response()->json(['html' => $html]);
        }
