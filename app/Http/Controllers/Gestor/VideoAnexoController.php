...
class VideoAnexoController extends Controller
{
     ...
     */
    public function delete(Request $request, \App\Models\VideoAnexo $anexo)
    {
    ...
    {
        $anexo = new \App\Models\VideoAnexo([
            'tipo' => $tipo,
            'post_id' => $post,
        ]);
        $anexo->save();
        ...
        if (!$upload) {
            ...
            $html = view('gestor.videos.foto', compact('anexo'))->render();
    ...
    public function uploadArquivo($request, $post, $tipo)
    {
        ...
        if (!$upload) {
            ...
            $html = view('gestor.videos.arquivo', compact('anexo'))->render();
            return response()->json(['html' => $html]);
        }
