...
class DivulgueController extends Controller
{
    ...
    public function index()
    {
        $pagina = \App\Models\Pagina::where('situacao', '1')
            ->where('link', 'divulgue-seu-evento')->firstOrFail();
        ...
        return view('web.divulgue-seu-evento.form', compact('pagina', 'promocao', 'video'));
    }
    ...
    {
        $pagina = \App\Models\Pagina::where('situacao', '1')
            ->where('link', 'divulgue-seu-evento')->first();
        ...
        if ($validator->fails()) {
            return redirect()->route('web.divulgue-seu-evento')
        ...
        try {
            ...
            return redirect()->route('web.divulgue-seu-evento')->with('alert', [
                'type' => 'danger',
