...
class PostAnexoController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function upload(Request $request, $post_id, $tipo)
    {
    ...
    public function uploadFoto($request, $post, $tipo)
    {
        ...
        if (!$upload) {
            ...
            $html = view('web.advogado-conta.artigo_foto', compact('anexo'))->render();
    ...
    public function uploadArquivo($request, $post, $tipo)
    {
        ...
        if (!$upload) {
            ...
            $html = view('web.advogado-conta.artigo_arquivo', compact('anexo'))->render();
            return response()->json(['html' => $html]);
        }
