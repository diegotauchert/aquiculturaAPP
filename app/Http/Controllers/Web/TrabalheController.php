...
class TrabalheController extends Controller
{
    ...
    public function index()
    {
        $pagina = \App\Models\Pagina::where('situacao', '1')
            ->where('link', 'trabalhe-conosco')->firstOrFail();
        ...
        return view('web.trabalhe-conosco.form', compact('pagina', 'promocao', 'video'));
    }
    ...
    {
        $pagina = \App\Models\Pagina::where('situacao', '1')
            ->where('link', 'trabalhe-conosco')->first();
        ...
        if ($validator->fails()) {
            return redirect()->route('web.trabalhe-conosco')
        ...
        try {
            ...
            return redirect()->route('web.trabalhe-conosco')->with('alert', [
                'type' => 'danger',
