...
class VaiPraOnde extends Model
{
    ...
    {
        return $this->hasMany('App\Models\VaiPraOndeAnexo', 'post_id', 'id');
    }

    public function categoria()
    {
        return $this->belongsTo('App\Models\VaiPraOndeCategoria', 'categoria_id', 'id');
    }
