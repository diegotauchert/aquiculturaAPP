...
return [
    ...
    'attributes' => [
        ...
        'f_menu' => 'menu',
        'f_tipo' => 'tipo',
        'f_password_current' => 'senha atual',
        'f_password' => 'senha',
        'f_password_new' => 'nova senha',
        'f_cidade' => 'cidade',
        'f_estado' => 'estado',
        'f_ibge_code' => 'código IBGE',
        'f_exibe' => 'exibe',
        'f_exibir_site' => 'exibir no site',
        'f_curso' => 'curso',
        'f_dt_inicio' => 'data de início',
        'f_dt_fim' => 'data de fim',
        'f_razao' => 'razão social',
        'f_apelido' => 'apelido',
        ...
        'f_agencia' => 'agência',
        'f_conta' => 'conta',
        'f_colaborador' => 'colaborador',
        'f_interessado' => 'interessado',
        'f_aluno' => 'aluno',
        'f_pessoa_cobranca' => 'responsável financeiro',
        'f_turma' => 'turma',
        'f_pagamento' => 'forma de pagamento',
        'f_parcelas' => 'número de parcelas',
        'f_professor' => 'professor',
        'f_tipo_conta' => 'tipo de conta',
        'f_foto' => 'foto',
        'f_parcelas_boleto' => 'número de parcelas',
        'f_parcelas_cartao' => 'número de parcelas',
        'f_texto_full' => 'página inteira',
        'f_anexo' => 'anexo',
        'f_produto' => 'produto',
        'f_estado_origem' => 'estado',
        'f_cidade_origem' => 'cidade',
        'f_estado_destino' => 'estado',
        'f_cidade_destino' => 'cidade',
    ],
    'format' => [
        'd/m/Y' => 'dia/mes/ano'
    ],
