...
@if($post->id)
@section('title', __('gestor.edicao') . ' - ' . __('gestor_post.cobertura'))
@else
@section('title', __('gestor.novo') . ' - ' . __('gestor_post.cobertura'))
@endif
...
<form method="POST" action="{{ ($post->id ? route('gestor.coberturas.update', $post->id) : route('gestor.coberturas.store')) }}">
    @if($post->id)
    @method('PUT')
    @endif
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.informacoes_cobertura')</div>
            <div class="card-body">
                <div class="form-row">
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.informacoes_texto_cobertura')</div>
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md">
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.informacoes_seo_cobertura')</div>
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md">
                        ...
                        <div id="seo_keywords" class="clones list-group">
                            ...
                            @include('gestor.coberturas.seo_keyword')
                            @endforeach
                            @else
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.fotos_cobertura')</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md py-2">
                        <div class="upload-anexos" data-up-tipo="foto" data-up-link="coberturas-anexos" data-up-id="{{ $post->id }}" data-up-nome="foto" data-up-class="col-md-6 my-auto py-3">
                            ...
                            <div class="files-itens files-ordem row pt-2">
                                ...
                                @include('gestor.coberturas.foto')
                                @endforeach
                                @endif
                            </div>
                        </div>
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.anexos_cobertura')</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md py-2">
                        <div class="upload-anexos" data-up-tipo="arquivo" data-up-link="coberturas-anexos" data-up-id="{{ $post->id }}" data-up-nome="arquivo" data-up-class="col-md-6 my-auto py-3">
                            <div class="list-group uploads pb-2"></div>
                            <div class="files-itens files-ordem row pt-2">
                                @if($post->anexos)
                                @foreach($post->anexos->where('tipo', 2)->sortBy('ordem') as $anexo)
                                @include('gestor.coberturas.arquivo')
                                @endforeach
                                @endif
                            </div>
                        </div>
