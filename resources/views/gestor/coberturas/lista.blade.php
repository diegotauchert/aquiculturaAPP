...
<div class="row">
    ...
    @permissao('gestor', 'gestor.coberturas.create')
    <div class="col col-sm-auto my-auto py-2 text-center text-md-right">
        <a href="{{ route('gestor.coberturas.create') }}" class="btn btn-primary"><span class="fas fa-asterisk"></span> @lang('gestor_post.create_cobertura')</a>
    </div>
    @endpermissao
</div>
<div id="busca" class="pb-2">
    <form class="form-horizontal" method="GET" action="{{ route('gestor.coberturas.index') }}">
            ...
            <table width="100%" class="table table-striped table-hover" id="datatable">
                ...
                <th class="align-middle">
                    <label class="custom-control custom-checkbox">
                        ...
                        <span class="custom-control-label">@lang('gestor_post.cobertura')</span>
                    </label>
                </th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-right">
                            <form method="POST" action="{{ route('gestor.coberturas.destroy', $post->id) }}">
                                @method('DELETE')
                                @csrf

                                <div class="btn-group">
                                    @permissao('gestor', 'gestor.coberturas.edit')
                                    <a href="{{ route('gestor.coberturas.edit', $post->id) }}" class="btn btn-outline-primary btn-sm" data-toggle="tooltip" title="@lang('gestor.edit')"><span class="fas fa-pen"></span> @lang('gestor.edit')</a>
                                    @endpermissao
                                    @permissao('gestor', 'gestor.coberturas.destroy')
