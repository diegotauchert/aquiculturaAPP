...
@if($post->id)
@section('title', __('gestor.edicao') . ' - ' . __('gestor_post.colunista'))
@else
@section('title', __('gestor.novo') . ' - ' . __('gestor_post.colunista'))
@endif
...
<form method="POST" action="{{ ($post->id ? route('gestor.colunistas.update', $post->id) : route('gestor.colunistas.store')) }}">
    @if($post->id)
    @method('PUT')
    @endif
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.informacoes_colunista')</div>
            <div class="card-body">
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md">
                        ...
                        <input name="f_instagram" id="f_instagram" type="text" required value="{{ (old('f_instagram') ? old('f_instagram') : $post->instagram) }}" class="form-control normatize @error('f_instagram') is-invalid @enderror" maxlength="250" placeholder="@lang('gestor_post.instagram')">
                        @error('f_instagram')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.informacoes_texto_colunista')</div>
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md">
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.informacoes_seo_colunista')</div>
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md">
                        ...
                        <div id="seo_keywords" class="clones list-group">
                            ...
                            @include('gestor.colunistas.seo_keyword')
                            @endforeach
                            @else
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.fotos_colunista')</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md py-2">
                        <div class="upload-anexos" data-up-tipo="foto" data-up-link="colunistas-anexos" data-up-id="{{ $post->id }}" data-up-nome="foto" data-up-class="col-md-6 my-auto py-3">
                            ...
                            <div class="files-itens files-ordem row pt-2">
                                ...
                                @include('gestor.colunistas.foto')
                                @endforeach
                                @endif
                            </div>
                        </div>
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.anexos_colunista')</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md py-2">
                        <div class="upload-anexos" data-up-tipo="arquivo" data-up-link="colunistas-anexos" data-up-id="{{ $post->id }}" data-up-nome="arquivo" data-up-class="col-md-6 my-auto py-3">
                            <div class="list-group uploads pb-2"></div>
                            <div class="files-itens files-ordem row pt-2">
                                @if($post->anexos)
                                @foreach($post->anexos->where('tipo', 2)->sortBy('ordem') as $anexo)
                                @include('gestor.colunistas.arquivo')
                                @endforeach
                                @endif
                            </div>
                        </div>
