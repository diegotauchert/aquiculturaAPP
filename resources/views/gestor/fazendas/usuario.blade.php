...
<form method="POST" action="{{ route('gestor.fazendas.usuario.save') }}">
    @csrf
    ...
    <div class="row">
        <div class="col-md">
            <div class="py-2">
                <div class="card">
                    <div class="card-header h5">Novo Usuário</div>
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md">
                                <label for="f_nome" class="form-control-label">* @lang('gestor_usuario.nome')</label>
                                <input name="f_nome" id="f_nome" type="text" class="form-control @error('f_nome') is-invalid @enderror" maxlength="250" placeholder="@lang('gestor_usuario.nome')">
                                @error('f_nome')
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input name="f_usuario" id="f_usuario" type="text" class="form-control @error('f_usuario') is-invalid @enderror" maxlength="250" placeholder="@lang('gestor_usuario.login')">
                                @error('f_usuario')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group col-sm">
                                ...
                                <select name="f_tipo" id="f_tipo" class="form-control selectpicker-custom" title="@lang('gestor_usuario.tipo')">
                                    <option value="" disabled selected>@lang('gestor_usuario.tipo')</option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm">
                                ...
                                <div class="input-group">
                                    <input name="f_password_confirmation" id="f_password_confirmation" type="password" class="form-control @error('f_password') is-invalid @enderror" maxlength="100" placeholder="@lang('gestor_usuario.password_confirmation')">
                                    <div class="input-group-append">
                                        <button class="mostrar-senha btn btn-secondary o-tooltip" title="@lang('gestor.show')/@lang('gestor.hide')" type="button"><span class="fas fa-eye"></span></button>
                                    </div>
                                </div>
