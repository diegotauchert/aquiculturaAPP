<div class="clone item list-group-item p-0">
    <div class="row no-gutters">
        <div class="col-md my-auto">
            <div class="p-4">
                <label for="f_seo_keyword_{{ $seo_keyword_k }}" class="form-control-label">@lang('gestor_pagina.seo_keyword')</label>
                <input name="f_seo_keyword[]" id="f_seo_keyword_{{ $seo_keyword_k }}" type="text" value="{{ (old('f_seo_keyword')[$seo_keyword_k] ? old('f_seo_keyword')[$seo_keyword_k] : $seo_keyword) }}" class="form-control @error('f_seo_keyword') is-invalid @enderror" maxlength="250" placeholder="@lang('gestor_pagina.seo_keyword')" data-clone-id="f_seo_keyword">
                @error('f_seo_keyword')
