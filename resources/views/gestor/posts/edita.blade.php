...
@if($post->id)
@section('title', __('gestor.edicao') . ' - ' . __('gestor_post.titulo'))
@else
@section('title', __('gestor.novo') . ' - ' . __('gestor_post.titulo'))
@endif
...
<form method="POST" action="{{ ($post->id ? route('gestor.posts.update', $post->id) : route('gestor.posts.store')) }}">
    @if($post->id)
    @method('PUT')
    @endif
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.informacoes')</div>
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md">
                        ...
                        <select name="f_categoria" id="f_categoria" class="form-control selectpicker-custom" title="@lang('gestor_post.categoria')">
                            <option value="">@lang('gestor_post.categoria')</option>
                ...
                <div class="form-row">
                    <div class="form-group col-md">
                        ...
                        <input name="f_nome" id="f_nome" type="text" value="{{ (old('f_nome') ? old('f_nome') : $post->nome) }}" class="form-control normatize @error('f_nome') is-invalid @enderror" maxlength="250" placeholder="@lang('gestor_post.nome')" data-ref="f_link">
                        @error('f_nome')
                ...
                <div class="form-row">
                    <div class="form-group col-lg-a">
                        ...
                        <div class="input-group">
                            <input name="f_data" id="f_data" type="text" value="{{ (old('f_data') ? old('f_data') : ($post->data ? $post->data->format('d/m/Y') : '')) }}" class="form-control maskdata @error('f_data') is-invalid @enderror" placeholder="@lang('gestor_post.data')" />
                            <div class="input-group-append">
                                <div class="input-group-text"><span class="fas fa-calendar-alt"></span></div>
                            </div>
                            <input name="f_hora" id="f_hora" type="text" value="{{ (old('f_hora') ? old('f_hora') : ($post->data ? $post->data->format('H:i:s') : '')) }}" class="form-control maskhora @error('f_hora') is-invalid @enderror" placeholder="@lang('gestor_post.hora')">
                            <div class="input-group-append">
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.informacoes_texto')</div>
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md">
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.informacoes_seo')</div>
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md">
                        ...
                        <div id="seo_keywords" class="clones list-group">
                            ...
                            @include('gestor.posts.seo_keyword')
                            @endforeach
                            @else
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.fotos_post')</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md py-2">
                        <div class="upload-anexos" data-up-tipo="foto" data-up-link="posts-anexos" data-up-id="{{ $post->id }}" data-up-nome="foto" data-up-class="col-md-6 my-auto py-3">
    ...
    <div class="py-2">
        <div class="card">
            <div class="card-header h5">@lang('gestor_post.anexos_post')</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md py-2">
                        <div class="upload-anexos" data-up-tipo="arquivo" data-up-link="posts-anexos" data-up-id="{{ $post->id }}" data-up-nome="arquivo" data-up-class="col-md-6 my-auto py-3">
                            <div class="list-group uploads pb-2"></div>
                            <div class="files-itens files-ordem row pt-2">
                                @if($post->anexos)
                                @foreach($post->anexos->where('tipo', 2)->sortBy('ordem') as $anexo)
                                @include('gestor.posts.arquivo')
                                @endforeach
                                @endif
                            </div>
                        </div>
