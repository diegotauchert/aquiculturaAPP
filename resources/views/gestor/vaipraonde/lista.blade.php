...
<div class="row">
    ...
    @permissao('gestor', 'gestor.vaipraonde.create')
    <div class="col col-sm-auto my-auto py-2 text-center text-md-right">
        <a href="{{ route('gestor.vaipraonde.create') }}" class="btn btn-primary"><span class="fas fa-asterisk"></span> @lang('gestor_post.create_vaipraonde')</a>
    </div>
    @endpermissao
</div>
<div id="busca" class="pb-2">
    <form class="form-horizontal" method="GET" action="{{ route('gestor.vaipraonde.index') }}">
            ...
            <table width="100%" class="table table-striped table-hover" id="datatable">
                ...
                <th class="align-middle">
                    <label class="custom-control custom-checkbox">
                        ...
                        <span class="custom-control-label">@lang('gestor_post.vaipraonde')</span>
                    </label>
                </th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-right">
                            <form method="POST" action="{{ route('gestor.vaipraonde.destroy', $post->id) }}">
                                @method('DELETE')
                                @csrf

                                <div class="btn-group">
                                    @permissao('gestor', 'gestor.vaipraonde.edit')
                                    <a href="{{ route('gestor.vaipraonde.edit', $post->id) }}" class="btn btn-outline-primary btn-sm" data-toggle="tooltip" title="@lang('gestor.edit')"><span class="fas fa-pen"></span> @lang('gestor.edit')</a>
                                    @endpermissao
                                    @permissao('gestor', 'gestor.vaipraonde.destroy')
