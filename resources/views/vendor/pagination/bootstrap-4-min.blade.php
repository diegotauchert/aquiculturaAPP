<p class="h6 m-0 py-2 text-center">@lang('gestor.total', ['first' => $paginator->firstItem(), 'last' => $paginator->lastItem(), 'total' => $paginator->total()])</p>
@if ($paginator->hasPages())
<ul class="pagination justify-content-center m-0 py-2" role="navigation">
    {{-- Previous Page Link --}}
