<div class="col-lg-3 py-2 sidebar-post">
    <div class="infobox p-4">
        ...
        <form action="@if(Request::segment(1) == 'blog'){{ route('web.blog.categoria') }} @elseif(Request::segment(1) == 'midia') {{ route('web.midia.categoria') }} @elseif(Request::segment(1) == 'media') {{ route('web.media.categoria') }} @endif">
    ...
    <div class="top-viewers">
        <p class="pt-5 pb-2 text-white h4">@lang('web_blog.top_views')</p>
        <div>
